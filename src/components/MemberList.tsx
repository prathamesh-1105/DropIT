            ...
            >
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2.5 min-w-0">
                  <div className="w-8 h-8 rounded-full bg-[#ffda3f] text-[#060606] flex items-center justify-center text-xs font-sans font-extrabold shrink-0 shadow-xs">
                    {member.displayName.charAt(0).toUpperCase()}
                  </div>
                  <span className="font-sans font-bold text-sm text-[#060606] dark:text-white truncate">
                    {member.displayName}
                  </span>
                  {isYou && (
                    <span className="text-meta px-2 py-0.5 rounded-full bg-[#eee8d2] dark:bg-[#111c36] text-[#060606] dark:text-amber-400 border border-[#e7dfcd] dark:border-white/15 shrink-0">
                      You
                    </span>
                  )}
                </div>
              ...
              <div className="flex items-center justify-between text-xs text-slate-600 dark:text-slate-400 pt-2 border-t border-[#e7dfcd]/60 dark:border-white/10 font-sans font-medium">
              ...
              {/* Hover actions */}
              <div className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-1 bg-[#060606]/90 dark:bg-[#111c36]/90 rounded-xl p-1 border border-slate-700 shadow-md">
